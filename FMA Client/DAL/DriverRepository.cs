...
namespace DAL
{
    public class DriverRepository : IDriverRepository
    {
        ...
        public bool Exists(int? driverId, string firstName, string lastName, string dateOfBirth, string nationalIdentificationNumber, string licenses)
        {
            throw new NotImplementedException();
        }
        ...
        public void InsertDriver(string firstName, string lastName, string dateOfBirth, string nationalIdentificationNumber, string licenses)
        {
            throw new NotImplementedException();
        }
    }
